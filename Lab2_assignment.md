Lab2\_assignment
================
Assignment created by: Matt Harris // completed by: Alex Cartwright
9/10/2021
...
``` r
acs_vars <- c("B25003_001", # Total housing units occupied
...
acsTractsPHL.2019.sf <- get_acs(geography = "tract",
  ...
  rename (total_occupied.2019 = B25003_001E,
          owner_occupied.2019 = B25003_002E,
          renter_occupied.2019 = B25003_003E) %>%
  mutate(renterPct.2019 = renter_occupied.2019/total_occupied.2019) %>%
